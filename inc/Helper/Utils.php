...
class Utils
{
    ...
    /**
     * remove pro attributes 
     *
     * @param array $attributes
     * @return void
     */
    public static function removeProAttributes(array $attributes): array
    {
        if (function_exists('bp3d_fs') && bp3d_fs()->can_use_premium_code()) {
            return $attributes;
        }
        ...
        if (isset($attributes['model']) && is_array($attributes['model'])) {
            $model_pro_keys = [
                'skyboxImage',
                'environmentImage',
                'arEnabled',
            ...
            foreach ($model_pro_keys as $key) {
                unset($attributes['model'][$key]);
            }
        }
