...
/**
 * Extracts all material data from a model-viewer's loaded model.
 */
export function getAllMaterialData(model: HTMLModelViewerElement): AllMaterialData {
    if (!model.model) {
        console.warn('Model not loaded yet.');
        return {};
    }

    const materialsData: AllMaterialData = {};

    model.model.materials.forEach((material: any) => {
