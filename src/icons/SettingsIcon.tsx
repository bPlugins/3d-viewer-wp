...
const SettingsIcon: React.FC<SettingsIconProps> = ({ size, ...props }) => (
    <svg id="svg69" xmlSpace="preserve" width={size} height={size} viewBox="0 0 682.66669 682.66669" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs id="defs73">
        ...
        <g id="g75" transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
            <g id="g77">
                <g id="g79" clipPath="url(#clipPath83)">
                    <g id="g85" transform="translate(256,334.6665)">
                        <path
